...
export default function Hero() {
  ...
  // ✅ Icon positions that change dynamically
  const iconPositions = [
    [
      { top: "10%", left: "65%" },
      { top: "50%", left: "10%" },
  ...
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-br from-[#021221] via-[#04315A] to-[#021221] flex items-center justify-center overflow-hidden">
      <div className="max-w-7xl w-full flex flex-col md:flex-row items-center px-6 sm:px-8 md:px-10 lg:px-16 py-20 gap-10 md:gap-0">
        {/* ✅ Left Section */}
